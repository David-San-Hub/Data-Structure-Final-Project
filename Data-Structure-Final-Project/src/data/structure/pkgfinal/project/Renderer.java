package data.structure.pkgfinal.project; 
...
public class Renderer extends JPanel { //this class is for rendering that helps buffering
    ...
    protected void paintComponent(Graphics g) {
            ...
            DataStructureFinalProject.FlappyBird.repaint(g); //performs a request to erase and perform redraw of the component after a small delay in time
	}
}