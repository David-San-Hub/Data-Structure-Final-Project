package data.structure.pkgfinal.project; //this is the package that contains classes that we put in
...
public class DataStructureFinalProject implements ActionListener, MouseListener, KeyListener {
    
    public static DataStructureFinalProject FlappyBird; //create static instance 
    ...
    public DataStructureFinalProject() { 
    ...
    public void actionPerformed(ActionEvent e) { //this method is for the bird's motion, movement, and game over + the pipes moving from right to left
        ...
        if (started) {
            for (int i = 0; i < columns.size(); i++) { //create for loop  for pipes
            ...
            if (ticks % 2 == 0 && yMotion < 15) { //physics for the bird to fall
            
                yMotion += 2; 
            }
        
            for (int i = 0; i < columns.size(); i++) { //this deletes column after went left and generate right again (making it infinite)
    ...
    public static void main(String[] args) { 
        ...
        FlappyBird = new DataStructureFinalProject();
